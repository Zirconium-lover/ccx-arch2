#ifndef CCX_CALCULIX_H
#define CCX_CALCULIX_H
...
/* The extension's own declarations used to sit here, 1466 lines of them,
   and every one of the 210 .c files that include this header paid for a
   change to any of them.  They are in ccxfork.h now (and ccxopt.h and
   logview.h for the two that are platform rather than mechanism).  Nothing
   below or above this point knows about the extension. */
